      ...
      <Container>
        ...
        <div className="mb-12">
          ...
          <p className="mt-4 max-w-xl text-base text-brown/70">
            ...
            pedido. También puedes visitarnos directamente en la Plaza.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-start">
          ...
          <div className="flex flex-col gap-8">
            {/* WhatsApp */}
            <div className="rounded-2xl border border-brown/10 bg-cream-50 p-6">
            ...
            <div className="rounded-2xl border border-brown/10 bg-cream-50 p-6">
              ...
              <p className="mb-4 text-sm text-brown/70">
                Seguinos para ver nuestros productos del día, novedades y
                contenido artesanal.
              </p>
              <ButtonLink
          ...
          <div className="sticky top-24">
            ...
            >
              <div className="flex aspect-[4/3] w-full flex-col items-center justify-center gap-4 bg-cream-100 transition-colors group-hover:bg-cream-50">
                <MapPin
                  size={56}
